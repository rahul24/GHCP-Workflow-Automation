...
2. Use `/review` skill to start the PR review. The output of the review is saved in the markdown file under the docs folder. The name of the file should include sessionid and date.
